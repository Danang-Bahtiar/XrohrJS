import { AuthServiceConfig, XrohrConfig } from "../config/Xrohr.config.js";
...
import { MemoriesConfig, SchemaDefinition } from "../modules/Memoria/Memoria.type.js";
...
class XrohrJS {
  ...
  /**
   * Creates a Memories configuration.
   * @param config - The memories configuration.
   * @returns 
   */
  static Memories = (config: MemoriesConfig) => {
    return config;
  }

  static AuthConfig = (config: AuthServiceConfig) => {
    return config;
  }
}

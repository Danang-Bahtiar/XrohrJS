 ...
 * @param absoluteUri - A boolean flag indicating whether the endpoint is an absolute URI (true) or a relative path (false). If false, the endpoint will be combined with the base URL of the target node. if true, the endpoint will be used as-is without modification and ignoring any urls in the edgeNode.mainUrls or mainNode.edgeUrls list. This will also ignore simplex routing and always go directly to the specified endpoint.
